<div class="left-side-bar">
		<div class="brand-logo">
			<a href="{{ url('/') }}">
				<img src="{{ asset('assets/images/coinally.png') }}" alt="" class="dark-logo">
				<img src="{{ asset('assets/images/coinally.png') }}" alt="" class="light-logo">
			</a>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					{{-- <li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="{{ url('buy-unit') }}">Buy Unit</a></li>
							<li><a href="{{ url('credits') }}">Purchase History</a></li>
						</ul>
					</li> --}}
					{{-- <li>
					...
					<li>
						<a href="https://dropways.github.io/deskapp-free-single-page-website-template/" target="_blank" class="dropdown-toggle no-arrow">
							...
							<span class="mtext">Landing Page <img src="{{ asset('admin/vendors/images/coming-soon.png') }}" alt="" width="25"></span>
						</a>
					</li> --}}
				</ul>
			</div>
